...
export const COLORS = {
    ...
    // ==========================================
    // 編輯個人資料 (Edit Profile) & 彈窗 (Modal)
    // ==========================================
    editProfileTagBg: '#D9D9D9', // 學系標籤背景顏色
    editProfileTagText: '#000000', // 學系標籤文字顏色
    editProfileSaveBtn: '#D0B589', // 儲存設定按鈕背景色
    modalSelectedBg: '#D0B589', // 彈窗選擇項目的背景與邊框顏色
    ...
    tags: {
        ...
        '必修': { bg: '#FFCCD5', border: '#D99AAB', text: '#000000' }, // 淺紅系
        '選修': { bg: '#CDE4FF', border: '#9CBCE3', text: '#000000' }, // 淺藍系
